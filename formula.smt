...
(declare-const	<v2_p>	RDFValue)
(declare-const	<v2_s>	RDFValue)

; ------------ Assumption ---------------------------
(assert 
	(and 
		(or (P <v2_s> <v2_p> <v2_o> <default_graph>) )
	)
)

; ------------ Conjecture ---------------------------
(assert (not (exists ((<v1_o> RDFValue)(<v1_p> RDFValue)(<v1_s> RDFValue)) 
	(and 
		(or (P <v1_s> <v1_p> <v1_o> <default_graph>) )
		(= <v2_s> <v1_s>) 
	)
)))
